	...
	public static void RegisterItems()
	{
		...
		//Tannin Recipe Display
			...
			RecipeDisplay.CUSTOM_RECIPES.add(new CustomRecipeType("Mixing", mixingItemDisplay, "mix_tannin", Main.INSTANCE, 
					...
					new CustomItemStack(ChatColor.RED + "-->", MyItems.glass_jar_tannin.getRootItem().getType(), MyItems.glass_jar_tannin.getDisplayCustomModelData()).AddEnchant(Enchantment.LUCK, 1, true).AddFlags(ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ENCHANTS).GetMyItemStack(),
		...
		animal_hide = new CustomItemStack("Animal Hide", Material.LEATHER, 10001);
		...
		soaked_animal_hide = new CustomItemStack("Soaked Animal Hide", Material.LEATHER, 10002);
		...
		CustomItemStack red_leather = new CustomItemStack("Red Leather", Material.LEATHER, 20016);
