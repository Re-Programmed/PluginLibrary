...
public class EnergyReceiver4 extends EnergyCompatible {
	
	public EnergyReceiver4()
	{
		CustomItemStack cis = ItemCreator.RegisterNewItem(new CustomItemStack("Energy Receiver MK. IV", Material.POLISHED_ANDESITE, 21012));
	...
	public void Tick(Location loc) {
		...
		for(BlockFace bf : checkFaces)
		{
			...
			for(EnergyCompatible ec : Main.energyRecievers)
			{
				...
				{
					ec.AddEnergy(RemoveEnergy(250, loc), b.getLocation());
				}
			}
		}
	}
