...
public class CustomPopulator extends BlockPopulator {
	...
	public void populate(World world, Random random, Chunk chunk) {
		...
		for(Ore ore : getOres())
		{
			GenerateOre(world, random, chunk, ore.drop.GetMyItemStack().getType(), ore.rarity, ore.yMinSpawn, ore.ySpawnCap, ore.veins, ore.netherOre ? Material.NETHERRACK : Material.STONE, ore.drop, ore.placeCustom, ore.mustHaveAir);
		}
	}
